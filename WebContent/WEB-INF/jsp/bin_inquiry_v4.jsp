...
<%@ page import="posfix.core.response.BinNumberInquiryV4Response" %>
...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
		...
		*/
        ...
        BinNumberInquiryV4Request binRequest = new BinNumberInquiryV4Request();
        binRequest.binNumber = request.getParameter("binNumber");
        binRequest.amount = request.getParameter("amount");
        BinNumberInquiryV4Response binResponse = BinNumberInquiryV4Request.execute(binRequest, settings); // "Bin sorgulama servisinin başlatıldığı kısım"
